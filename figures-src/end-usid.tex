...
\begin{document}%
    ...
    \node[align=left, opacity=0, anchor=south west, yshift=-5mm] at (0,0) (sample) {DA:~\texttt{fc00:0:2:3:4:}};
    \tikzmath{
        coordinate \wNode;
    ...
    \tikzset{albl/.style={font=\Large}}
        ...
        \node[below=.1cm of 2, albl] (label) {End with uSID (uN)};
    ...
    \node[right=.2cm of 2br.east, anchor=north west](pkt2){%
      \ipsixpktnew[\pktwidth pt]{\texttt{fc00:0:1::1}}{\texttt{fc00:0:\underline{3:4::}}}%
    };
    % size of pkt2
    ...
    \node[left=.2cm of 2bl.west, anchor=south east] at (2bl.west|-pkt2.south) (pkt1){%
      \ipsixpktnew[\pktwidth pt]{\texttt{fc00:0:1::1}}{\texttt{fc00:0:2:3:4::}}%
    };
    % size of pkt1
