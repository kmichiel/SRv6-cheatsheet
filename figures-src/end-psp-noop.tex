...
\begin{document}%
    ...
    % pkt2
    \node[right=.2cm of 2br.east, anchor=north west](pkt2){\ipsrhpktnew[\pktwidth pt]{\texttt{fc00:0:1::1}}{\texttt{\underline{fc00:0:3::}}}%
    {(\texttt{fc00:0:4::}, \\\phantom{(}\texttt{fc00:0:3::},\\\phantom{(}\texttt{fc00:0:2::})}%
    {\underline{1}}};
    % size of pkt2
    ...
    % pkt1
    \node[left=.2cm of 2bl.west, anchor=south east] at (2bl.west|-pkt2.south) (pkt1){\ipsrhpktnew[\pktwidth pt]{\texttt{fc00:0:1::1}}{\texttt{fc00:0:2::}}%
    {(\texttt{fc00:0:4::}, \\\phantom{(}\texttt{fc00:0:3::},\\\phantom{(}\texttt{fc00:0:2::})}%
    {2}};
    % size of pkt1
