...
\begin{document}%
    ...
    \node[align=left, opacity=0, anchor=south west, yshift=-1cm] at (0,0) (sample) {DA:~\texttt{fc00:0:2:e003:}};
    \tikzmath{
        coordinate \wNode;
    ...
    \tikzstyle{uAarrow}=[>={Straight Barb[width=12pt,length=8pt]}]
        ...
        \node[below=.1cm of 2, albl] (label) {End.X};
        ...
        \node[right=.2cm of 2br.east, anchor=north west](pkt2){%
            \begin{srv6packetnew}[\pktwidth pt]%
                ...
                \srhdrnew{(\texttt{fc00:0:5::}, \\\phantom{(}\texttt{fc00:0:4::},\\\phantom{(}\texttt{fc00:0:2:e003::})}%
                {\underline{1}}%
            \end{srv6packetnew}%
        };
