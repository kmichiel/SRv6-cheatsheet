...
Div = function (div)
  ...
  if #div.content == 4
    ...
    and div.content[4].text:match '\\end{codelisting}' then
      ...
      -- print(caption)
      -- caption may contain markdown markings
      -- convert markdown to latex
      local mdcaption = pandoc.read(caption, "markdown")
      --print(mdcaption)
      local latexcaption = pandoc.write(mdcaption, "latex")
      --print(latexcaption)
      ...
      --\end{SRExample}
      div.content[1].text = '\\begin{SRExample}{' .. (latexcaption or '') .. '}{' .. label .. '}{'.. numbers .. '}\n' .. codeblock.text .. '\n\\end{SRExample}'
